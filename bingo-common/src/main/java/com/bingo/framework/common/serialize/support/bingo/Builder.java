...
import com.bingo.framework.common.bytecode.ClassGenerator;
...
import com.bingo.framework.common.serialize.support.java.CompactedObjectInputStream;
import com.bingo.framework.common.serialize.support.java.CompactedObjectOutputStream;
...
public abstract class Builder<T> implements GenericDataFlags
{
	...
	public static <T> Builder<T> register(Class<T> c, boolean isAllowNonSerializable)
    {
        ...
        if(!isAllowNonSerializable && !isSerializable) {
            ...
            " must implement java.io.Serializable (bingo codec setting: isAllowNonSerializable = false)");
        }
