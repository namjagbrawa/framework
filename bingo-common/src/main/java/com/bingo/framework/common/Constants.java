...
public class Constants {
    ...
    public static final String  BINGO_PROPERTIES_KEY               = "bingo.properties.file";

    public static final String  DEFAULT_BINGO_PROPERTIES           = "bingo.properties";
    ...
    public static final String  DEFAULT_DIRECTORY                  = "bingo";

    public static final String  DEFAULT_LOADBALANCE                = "random";

    public static final String  DEFAULT_PROTOCOL                   = "bingo";
    ...
    public static final String  DEFAULT_REMOTING_CODEC             = "bingo";
    ...
    public static final String  DEFAULT_THREAD_NAME                = "Bingo";
    ...
    public static final String  DEFAULT_REGISTRY                   = "bingo";
    ...
    public static final String  DEFAULT_PROMPT                     = "bingo>";
    ...
    public static final String  INVOCATION_CHANNEL                 = "invocation.channel";

    public static final String  REVISION_KEY                       = "revision";

    public static final String  BINGO_VERSION_KEY                  = "bingo";
    ...
    @Deprecated
    public static final String  SHUTDOWN_WAIT_SECONDS_KEY          = "bingo.service.shutdown.wait.seconds";

    public static final String  SHUTDOWN_WAIT_KEY                  = "bingo.service.shutdown.wait";
    ...
    public static final String  STUB_EVENT_KEY                     = "bingo.stub.event";

    public static final boolean DEFAULT_STUB_EVENT                 = false;

    public static final String  STUB_EVENT_METHODS_KEY             = "bingo.stub.event.methods";
