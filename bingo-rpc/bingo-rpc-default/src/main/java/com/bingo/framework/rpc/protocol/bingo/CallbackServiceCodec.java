...
class CallbackServiceCodec {
    ...
    private static final BingoProtocol protocol = BingoProtocol.getBingoProtocol();
    ...
    private static String exportOrunexportCallbackService(Channel channel, URL url, Class clazz, Object inst, Boolean export) throws IOException{
        ...
        //增加方法，变于方法检查，自动降级(见bingo protocol)
        ...
        URL exporturl = new URL(BingoProtocol.NAME, channel.getLocalAddress().getAddress().getHostAddress(), channel.getLocalAddress().getPort(), clazz.getName()+"."+instid, tmpmap);
    ...
    public static Object decodeInvocationArgument(Channel channel, RpcInvocation inv, Class<?>[] pts, int paraIndex, Object inObject) throws IOException{
        ...
        URL url = null ;
        try {
            url = BingoProtocol.getBingoProtocol().getInvoker(channel, inv).getUrl();
