 ...
 * @author chao.liuc
 */
public class BingoInvoker<T> extends AbstractInvoker<T> {
    ...
    public BingoInvoker(Class<T> serviceType, URL url, ExchangeClient[] clients){
        this(serviceType, url, clients, null);
    }
    
    public BingoInvoker(Class<T> serviceType, URL url, ExchangeClient[] clients, Set<Invoker<?>> invokers){
