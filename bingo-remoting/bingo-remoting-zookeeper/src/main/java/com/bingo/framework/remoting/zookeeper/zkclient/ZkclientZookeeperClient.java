...
import com.bingo.framework.remoting.zookeeper.StateListener;
import com.bingo.framework.remoting.zookeeper.support.AbstractZookeeperClient;
...
import com.bingo.framework.remoting.zookeeper.ChildListener;
	...
	public ZkclientZookeeperClient(URL url) {
		...
		client.subscribeStateChanges(new IZkStateListener() {
			...
			public void handleSessionEstablishmentError(Throwable e) throws Exception {
				logger.error("handle session establishment error, {}", e);
			}
		});
	}
